...
result_grade_7 = read_xlsx_to_list(file_path=fr"2026.09.15 - 25学年第二学期数据源/七年级汇总表.xlsx")[1:]
...
check = []
ans_grade_7 = "A,A,A,A,D,A,C,A,C,A,B,B,C,B,B,C,B,C,B,A,B,A,B,B,B,A,C,D,B,C,D,C,D,".split(",")[:-1]
ans_html = ["√"] * 7
